...
The release process is done through Jenkins pipeline (https://blazect-jenkins.blazemeter.com/view/blazerunner-plugins/job/github-action-release) which uses github token. 
